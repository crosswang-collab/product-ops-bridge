...
- 原始 37 張 → active **26** 張（排除 11、未分類 0）
- 產能基準鎖定於 2026-08-21，2026-10-01 重算

## 跟上一份快照的差異

跟昨天（2026-09-08）那份比，active 從 **25** 張變成 **26** 張。

### 新進來的卡（1）

- **2253** Renew contract ph-1,  JP Direct streamer — Internal Tool／Discovery

### PM 改了狀態（2，其中 2 個變差）

- ⚠ **2133** [Commercial] Gacha Management - Archive / Delete — On track → Warning
- ⚠ **2238** Profile Badge Customization  — Warning → At Risk

### 換了階段（1）

- **1927** Enable Direct Message in JP — Develop → Impact

### 團隊負荷變化（1）

- **Internal Tool** — 1.57 → 2.05 個月（+0.48）
...
Teams 參與計數 28（>26 是正常的：跨團隊卡對每個參與團隊都計入完整 effort）
...
| --- | --- | --- |
| 17App | 6 | At Risk 1, On track 5 |
| IST | 7 | On track 7 |
| Internal Tool | 6 | On track 6 |
| Live Commerce | 3 | On track 1, Warning 2 |
