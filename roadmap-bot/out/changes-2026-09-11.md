...
跟昨天（2026-09-10）那份比，active 從 **24** 張變成 **24** 張。
...
- **1910** [Event] Use the standard extension flow when users receive the same virtual reward — Develop → Impact
- **2241** User Red Envelope Grabbing Conditions — Develop → Impact
