...
- 原始 37 張 → active **29** 張（排除 8、未分類 0）
- 產能基準鎖定於 2026-08-21，2026-10-01 重算

## 跟上一份快照的差異

跟昨天（2026-09-15）那份比，active 從 **29** 張變成 **29** 張。

### 換了階段（2）

- **2148** [IST O3] Pre-stream Speed Test & Streaming Quality Selection — Develop → Impact
- **2243** [IST O1O3][VoC] Prevent paid-gift-comments from merging — Develop → Impact

### 改了發布日（2）

- **2004** Add atone payment gateway in JP region — 2026-09-30 → 2026-10-01（延後 1 天）
- **2104** Content Evaluation Automation Integration — 2026-09-01 → 2026-10-01（延後 30 天）
