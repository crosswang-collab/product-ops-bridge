...
| stage Design | 9 | 11 | 差 -2 |
| stage Develop | 16 | 15 | 差 +1 |
| stage Impact | 4 | 4 | 一致 |
| 產能 17App 張數 | 7 | 9 | 差 -2 |
| 產能 17App 點數 | 21 | 24 | 差 -3 |
...
| Teams 參與計數 | 33 | 36 | 差 -3 |
| 2026-09-01 同日發布 | 9 | 7 | 差 +2 |
...
Teams 參與計數 33（>30 是正常的：跨團隊卡對每個參與團隊都計入完整 effort）

| Domain | 卡 | pts | 在途(月) | 判定 | 上游卡 | 上游(月) | 判定 | 基準薄弱 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 17App | 7 | 21 | 2.04 | healthy | 3 | 0.64 | medium |  |
| IST | 8 | 23 | 5.35 | overload | 1 | 0.59 | medium |  |
...
- **2026-09-01**：9 張 — APPIDEAS-1910, APPIDEAS-1927, APPIDEAS-1985, APPIDEAS-2104, APPIDEAS-2135, APPIDEAS-2169, APPIDEAS-2219, APPIDEAS-2212, APPIDEAS-2257
